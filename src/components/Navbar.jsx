...
export default function navbar() {
  var typed = new Typed(".auto-type", {
    strings: ["Ayush Baral", "Front-End Web Developer", "Entrepreneur", "Content Creator"],
    typeSpeed: 90,
    backSpeed: 90,
    loop: true
  })
...
<nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
  <a className="mr-5 text-gray-400 hover:text-white" href="#experience">Experience</a>
  <a className="mr-5 text-gray-400 hover:text-white" href="#contact">Contact</a>
</nav>
...
<div
  ...
  <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Hi, I am <span
      className="lg:inline-block text-green-500 auto-type"><Typed
      strings={['Ayush Baral',
  ...
  <p className="mb-8 leading-relaxed">
    I am 15 years old Boy and an intermediate-level Front-end Web
    Developer who develops front-end websites. I also founded a
    technical blogging company called "<a className="text-green-300" href="https://www.geekcreek.co.in" target="_blank" rel="noreferrer">Geek
      Creek</a>".
  </p>
  ...
  <div className="flex justify-center mt-6 -mx-2">
    <a className=" mx-2 btn inline-flex text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg"
      href="https://docs.google.com/forms/d/e/1FAIpQLSevCQd0nvoZJ2tUE8ZDq7Y0ckVZDAvoJ6NBi2H8tfwreW-uQQ/viewform" target="_blank" rel="noreferrer">Hire Me</a>
      <a className="mx-2 btn inline-flex text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg"
      href="mailto:ayushbaral010@gmail.com" target="_blank" rel="noreferrer">Contact Me</a>
  </div>
...
<div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
  <img className="object-cover object-center rounded" alt="mydp" src="https://2by-dev.github.io/Resume-Website/img/DP.jpg" />
</div>
</div>
    </div>
  )
